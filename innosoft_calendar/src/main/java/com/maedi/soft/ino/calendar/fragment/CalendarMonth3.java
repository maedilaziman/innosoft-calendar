...
public class CalendarMonth3 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_3 - ";
    ...
    public static CalendarMonth3 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth3 fragmentMonth = new CalendarMonth3();
