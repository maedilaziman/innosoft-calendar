...
public class CalendarMonth11 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_11 - ";
    ...
    public static CalendarMonth11 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth11 fragmentMonth = new CalendarMonth11();
