...
public class CalendarMonth5 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_5 - ";
    ...
    public static CalendarMonth5 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth5 fragmentMonth = new CalendarMonth5();
