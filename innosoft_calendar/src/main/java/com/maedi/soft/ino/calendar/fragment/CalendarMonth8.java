...
public class CalendarMonth8 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_8 - ";
    ...
    public static CalendarMonth8 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth8 fragmentMonth = new CalendarMonth8();
