...
public class CalendarMonth7 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_7 - ";
    ...
    public static CalendarMonth7 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth7 fragmentMonth = new CalendarMonth7();
