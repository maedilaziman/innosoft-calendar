...
public class CalendarMonth2 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_2 - ";
    ...
    public static CalendarMonth2 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth2 fragmentMonth = new CalendarMonth2();
