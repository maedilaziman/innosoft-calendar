...
public class CalendarMonth10 extends BaseFragment {
    ...
    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_10 - ";
    ...
    public static CalendarMonth10 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth10 fragmentMonth = new CalendarMonth10();
