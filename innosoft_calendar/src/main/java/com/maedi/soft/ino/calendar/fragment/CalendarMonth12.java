...
public class CalendarMonth12 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_12 - ";
    ...
    public static CalendarMonth12 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth12 fragmentMonth = new CalendarMonth12();
