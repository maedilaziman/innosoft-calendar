...
public class CalendarMonth9 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_9 - ";
    ...
    public static CalendarMonth9 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth9 fragmentMonth = new CalendarMonth9();
