...
public class CalendarMonth4 extends BaseFragment {

    private final String TAG = this.getClass().getName()+"- CALENDAR_MONTH_4 - ";
    ...
    public static CalendarMonth4 newInstance(CalendarDateAdapter.CalendarDateAdapter_Fragment1 listen) {
        CalendarMonth4 fragmentMonth = new CalendarMonth4();
    ...
    public void onViewMCreated(View v, Bundle savedInstanceState) {
        ...
        final RecyclerDate.CommGetRecyclerDate listenerDate = new RecyclerDate.CommGetRecyclerDate(){
